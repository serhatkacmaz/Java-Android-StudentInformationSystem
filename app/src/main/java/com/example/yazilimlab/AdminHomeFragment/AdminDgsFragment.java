...
public class AdminDgsFragment extends Fragment {
    ...
    // CardView Extand
    private CardView admin_DgsCardViewIncoming;
    private LinearLayout admin_DgsLinearLayoutIncoming;
    ...
    private void init() {
        ...
        // recyclerViewOnGoing
        admin_DgsRecyclerViewIncoming.setHasFixedSize(true);
        admin_DgsRecyclerViewIncoming.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        admin_DgsRecyclerViewIncoming.setAdapter(adminAppItemIncomingAdapter);
    ...
    private void eventChangeListenerIncoming() {
        firebaseFirestore.collection("Resources").whereEqualTo("type", "Dgs")
