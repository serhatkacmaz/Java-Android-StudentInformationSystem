...
public class AdminResources {
    ...
    // CardView Extend
    private CardView admin_CardViewIncoming,admin_CapCardViewAccept;
    private LinearLayout admin_LinearLayoutIncoming;

    private String type;
    private String state;

    public AdminResources(Context context, RecyclerView admin_RecyclerViewIncoming, CardView admin_CardViewIncoming, LinearLayout admin_LinearLayoutIncoming, String type, String state) {
        // input
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (DocumentChange dc : value.getDocumentChanges()) {
                            if (dc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                // gelen başvurular
                                if (dc.getDocument().getData().get("state").equals(state)) {
